This instrument backtester will act as a MT4/MT5 terminal in conjunction with a python script. It is a seperate windows app. The windows app will be installed by a setup  install file.
